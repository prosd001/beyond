  ...
  return lang ? (
    <div className="slider__home ">
      <Slider {...sliderHomeSettings}>
        <div className="text-white bg-no-repeat xl:bg-cover home__sbg_p relative">
          <div
        ...
        <div className="text-white bg-no-repeat xl:bg-cover home__sbg2_p relative">
          <div
            className="max-w-[1000px] mx-auto text-center xl:mt-[250px] mt-[150px]"
            data-aos="fade-up"
          >
        ...
        <div className="text-white bg-no-repeat xl:bg-cover home__sbg3_p relative">
          <div
            className="max-w-[1000px] mx-auto text-center xl:mt-[250px] mt-[150px]"
            data-aos="fade-up"
          >
        ...
        <div className="text-white bg-no-repeat xl:bg-cover home__sbg4_p relative">
          <div
            className="max-w-[1000px] mx-auto text-center xl:mt-[250px] mt-[150px]"
            data-aos="fade-up"
          >
